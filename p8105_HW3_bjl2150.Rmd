...
instacart_1B = instacart %>%
  ...
  arrange(desc(n))
```
In the first part of Question 1, the number of ailses was determined by selecting
...
"mean_hour" caluclated by takin he mean of "order_hout_of_day", while removing 
